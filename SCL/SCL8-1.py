...
#7- Display the shape of the dataset
...
# 9a - Display first  training image
# plt.subplot(1, 2, 1)
# #display 1st image
# plt.imshow(images_train[0])

# 9a - Display last  training image
# plt.subplot(1, 2, 2)
# plt.imshow(images_train[size-1])
# plt.show()

# 9b.	Create 5 subplots and display the first 5 images from the training dataset
...
# 10.	Build a basic neural network model.
...
# 13a - Display Training Results Graph - Accuracy
...
# 13b - Display Training Results Graph - Accuracy
plt.figure(figsize=(8, 4))
...
# 15 - Predict first test image
predicted_label = np.argmax(predictions[0])


print("Predicted Digit:", predicted_label)
print("Actual Digit:", labels_test[0])


# 16 - Display Prediction Result
plt.imshow(images_test[50], cmap="gray")
